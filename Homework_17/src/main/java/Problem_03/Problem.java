...
import Problem_03.Interfaces.IProcessCreator;
...
public class Problem implements IProblem {
    ...
    private String pathWrite = "src/main/resources/data.txt";
    ...
    private void serializeShop(FlowerShop shop){
        try(ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream(this.pathWrite))) {
