...
public class ProcessOwner extends Process implements IProcess {
    ...
    public void start() {
        ...
        do {
            ...
            choice = IConsole.getIntegerBounded(0, OPER_COUNT);
            switch (choice) {
                case 1: {
                    setPriceProcess();
                }
    ...
    private void setPriceProcess() {
        ...
        do {
            ...
            System.out.println("0 - Exit");
            System.out.print("Your choice:");
            typeNum = Interfaces.IConsole.getIntegerBounded(0, typesCount);
            if (typeNum > 0) {
                Class type = null;
                String color = null;
    ...
    private void setFormatProcess(){
        ...
        System.out.println("0 - Exit");
        System.out.print("Your choice: ");
        int choice = IConsole.getIntegerBounded(0, OPER_COUNT);
        switch(choice){
            case 1:
